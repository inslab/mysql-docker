...
#cp /tmp/mysqld_charset.cnf /etc/mysql/conf.d/mysqld_charset.cnf
if [ $(ls /etc/mysql | wc -l) -eq 0 ]; then
    echo "Restore backup /etc/mysql directory."
    cp -rf /etc/mysql_bak/* /etc/mysql/
fi
